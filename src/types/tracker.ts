...
export function buildSampleData(): Application[] {
  return [
    {
      id: 'demo-1',
      companyName: 'Acme AI',
...
export const SAMPLE_DATA: Application[] = buildSampleData();
